      ...
      <section className="relative min-h-[100dvh] bg-forest-dark flex items-center overflow-hidden pt-24 lg:pt-20">
        <div className="max-w-6xl mx-auto w-full px-6 flex flex-col lg:flex-row relative z-10 h-full">
          ...
          <div className="w-full lg:w-[50%] py-12 flex flex-col justify-center">
            ...
            <h1 className="font-serif text-5xl lg:text-[4rem] text-cream leading-[1.05] mb-5 lg:mb-4 animate-fade-in-up font-bold">
              WHERE<br />STYLE<br />
              <span className="text-gold">MEETS<br />COMFORT</span>
            </h1>
            
            <p className="text-cream/70 text-sm md:text-base font-light leading-relaxed max-w-sm mb-6 lg:mb-4">
            ...
            <div className="flex items-center gap-3 mb-8 lg:mb-6">
              ...
              <div className="text-[10px] tracking-widest text-cream/70 font-medium uppercase">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-10 lg:mb-8">
              ...
              <Link 
                href="#kafe" 
                className="w-full sm:w-auto border border-cream/20 text-cream px-10 py-4 text-[10px] font-bold tracking-[0.2em] hover:border-cream transition-colors uppercase text-center"
              >
                LIHAT MENU
              </Link>
            </div>
